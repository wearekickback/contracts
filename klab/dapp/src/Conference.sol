...
contract Conference {
    ...
    */
    function clear() external onlyEnded{
     ...
     */
    function setLimitOfParticipants(uint256 _limitOfParticipants) external onlyActive{
        limitOfParticipants = _limitOfParticipants;
     ...
     * @param _name the name of the event.
     */
    function changeName(string calldata _name) external noOneRegistered{
        name = _name;
    }
     ...
     */
    function finalize(uint256[] calldata _maps) external onlyActive {
